...
import static com.chameleon.web.webelements.impl.internal.ImplementedByProcessor.getWrapperClass;
...
public class ElementListHandler implements InvocationHandler {
    ...
    public <T> ElementListHandler(Class<T> interfaceType, ElementLocator locator, ExtendedWebDriver driver) {
        this.locator = locator;
        this.driver = driver;
        if (!Element.class.isAssignableFrom(interfaceType)) {
            throw new RuntimeException("interface not assignable to Element.");
    ...
    public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
        ...
        cons = wrappingType.getConstructor(ExtendedWebDriver.class, By.class, WebElement.class);
