...
public class ElementHandler implements InvocationHandler {
     ...
     */
    public <T> ElementHandler(Class<T> interfaceType, ElementLocator locator, ExtendedWebDriver driver) {
    ...
    public Object invoke(Object object, Method method, Object[] objects) throws Throwable {
        ...
        cons = wrappingType.getConstructor(ExtendedWebDriver.class, By.class);
