...
public class ElementDecorator implements FieldDecorator {
    ...
    public ElementDecorator(CustomElementLocatorFactory factory, ExtendedWebDriver driver) {
        this.factory = factory;
        this.driver = driver;
    }
    ...
    public Object decorate(ClassLoader loader, Field field) {
        ...
        final ExtendedWebDriver driverRef = driver;
    ...
    protected <T> T proxyForLocator(ClassLoader loader, Class<T> interfaceType, ElementLocator locator, ExtendedWebDriver driver) {
    ...
    protected <T> List<T> proxyForListLocator(ClassLoader loader, Class<T> interfaceType, ElementLocator locator, ExtendedWebDriver driver) {
