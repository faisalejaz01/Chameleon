...
public class PageLoaded {
    ...
    @Deprecated
    public static boolean isElementLoaded(Class clazz, ExtendedWebDriver oDriver, Element obj) {
    ...
    @SuppressWarnings("rawtypes")
    @Deprecated
    public static boolean isElementLoaded(Class clazz, ExtendedWebDriver oDriver, Element obj, int timeout) {
     ...
     */
    @Deprecated
    public static boolean isDomInteractive(ExtendedWebDriver oDriver) {
    ...
    public static boolean isDomInteractive() {
        ExtendedWebDriver driver = DriverManager.getDriver();
     ...
     */
    @Deprecated
    public static boolean isDomInteractive(ExtendedWebDriver oDriver, int timeout) {
     ...
     */
    @Deprecated
    public static boolean isAngularComplete(ExtendedWebDriver oDriver) {
     ...
     */
    @Deprecated
    public static boolean isDomComplete(ExtendedWebDriver driver) {
        return isDomComplete(driver, driver.getPageTimeout());
    }
     ...
     */
    @Deprecated
    public static boolean isDomComplete(ExtendedWebDriver driver, int timeout) {
