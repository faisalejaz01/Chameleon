package com.chameleon.utils.mustard;
...
public class Mustard {
    ...
    @Beta
    public static void postResultsToMustard(ExtendedWebDriver driver, ITestResult result, String runLocation, String base64Screenshot) {
