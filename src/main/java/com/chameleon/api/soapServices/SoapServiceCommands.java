...
public class SoapServiceCommands {
     ...
     * 
     * @param nodeList
     *            : Name of the nodes to create in a parent/child/grandchild entity
     *            <br>
     *            Example: nodeList = blah/blah2/blah3 will create the following XML
     *            <br>
     *            &lt;blah&gt;
     *            <br>
     *            &nbsp;&nbsp;&lt;blah2&gt;
     ...
     * 
     * @param daysOut
     *            Days from current date. Example: 3 will be three days from today, -7 will be ago
     ...
     * 
     * @param length
     *            length of random string to make
